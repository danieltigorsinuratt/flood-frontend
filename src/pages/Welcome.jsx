        ...
        >
          ...
          <div className="flex items-center gap-3">
            {canLogin && !user && (
              <Link
                href="/login"
                className="rounded-md border border-slate-600 bg-slate-800 px-3 py-1.5 text-sm font-medium text-white transition hover:bg-slate-700"
              >
                Login
              </Link>
            )}
